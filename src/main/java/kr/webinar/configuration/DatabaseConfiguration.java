package kr.webinar.configuration;

import com.zaxxer.hikari.HikariDataSource;
import kr.webinar.configuration.support.DatabaseProperties;
import kr.webinar.util.SystemEnvUtil;
...
@MapperScan(value = "kr.webinar.repository.mapper")
